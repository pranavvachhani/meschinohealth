<?php
	 ...
	 * The main one that is used in Starkers is MhWp::add_slug_to_body_class(), this will add the page or post slug to the body class
	 *
	 */
	 ...
	 class MhWp {
    	 ...
    	 * e.g. MhWp::get_page_id_from_path('about/terms-and-conditions');
    	 *
    	 * @param 	string 
    	 * @return 	integer
    	 * @author 	Keir Whitaker
